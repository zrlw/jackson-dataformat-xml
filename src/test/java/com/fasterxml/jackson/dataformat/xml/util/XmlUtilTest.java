...
public class XmlUtilTest extends TestCase {
     ...
     public void testXmlUtil() throws Exception {
         ...
         for (int i = 0; i < 5; i++) {
             ...
             MyEnvelope<MyStudent> myEnvelope1 = XmlUtil.xmlToObject(envelopeXml, myTypeReference);
             Assert.assertEquals(myEnvelope, myEnvelope1);

             byte[] bytes = XmlUtil.objectToBytes(myEnvelope);
             ...
             envelopeXml = XmlUtil.objectMapToXml(map);
